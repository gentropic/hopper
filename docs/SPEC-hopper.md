...
- **SPEC-hopper-geo** — geo capture done with care: live-converging fixes, accuracy surfaced + thresholded, occupy-and-average, honest metadata + datum (design / roadmap).
